...
//======= categories========
    'category' => [
        ...
        'choose_category' => 'Choose Main Category',
        'options' => ' Category options',
        'name' => 'Category name',
        'add' => 'add new category',
        'edit' => 'category edit ',
        'show' => ' show category ',
        'menu' => ' show category In Website ',
        'menu_index' => ' showing In Website ',
        'showing_in_web' => 'Appears',
        'not_showing_in_web' => 'Not Appears',
        'image' => 'category image ',
        'last_categories' => 'last categories',
        'sub_categories' => 'Subcategories Of This Category',
        'status' => 'Category Description',
        'real_estate' => 'Special for real estate',
        'cars' => 'Special for Cars',
    ],
...
//====================== buyers ====================
    ...
    'auction' => [
        ...
        'enter_name_of_the_licensor' => 'Enter Name of the licensor',
        'license_number'        => 'Advertising license number',
        'enter_license_number'  => 'Enter Advertising license number',
        'brokerage_license_number_for_brokers' => 'Brokerage license number for brokers',
        'enter_brokerage_license_number_for_brokers' => 'Enter Brokerage license number for brokers',
        'district'              => 'District',
        'street'                => 'Street',
        'property_facade'       => 'Property facade',
        'space'                 => 'Space',
        'purpose'               => 'Purpose',
        ...
        'services_related_to_the_property' => 'Services related to the property',
        'purpose_of_the_advertisement' => 'Purpose of the advertisement',
        'sale'                  => 'Sale',
        'rent'                  => 'Rent',
        'enter_district'        => 'Enter district',
        'enter_street'          => 'Enter street',
        'enter_property_facade' => 'Enter property facade',
        'enter_space'           => 'Enter space',
        'enter_price_per_meter_of_land' => 'Enter price per meter of land',
        'enter_unit_price'      => 'Enter unit price',
        'enter_villa_apartment_land' => 'Enter villa apartment land',
        'enter_age_of_the_property' => 'Enter age of the property',
        'enter_services_related_to_the_property' => 'Enter services related to the property',
    ...
    'product' => [
        ...
        'property_facade_er'        => 'Property facade in Arabic',
        ...
        'age_of_the_property'       => 'Age of the property in Arabic',
        'services_related_to_the_property_ar' => 'Services related to the property in Arabic',
        'services_related_to_the_property_en' => 'Services related to the property in English',
        'purpose_of_the_advertisement' => 'Purpose of the advertisement',
        'sale'                      => 'Sale',
        'rent'                      => 'Rent',
        'enter_district_ar'         => 'Enter district in Arabic',
        'enter_district_en'         => 'Enter district in English',
        'enter_street_ar'           => 'Enter street in Arabic',
        'enter_street_en'           => 'Enter street in English',
        'enter_property_facade_ar'  => 'Enter property facade in Arabic',
        'enter_property_facade_en'  => 'Enter property facade in English',
        'enter_space'               => 'Enter space',
        'enter_price_per_meter_of_land' => 'Enter price per meter of land',
        'enter_unit_price'          => 'Enter unit price',
        'enter_villa_apartment_land_ar' => 'Enter villa apartment land in Arabic',
        'enter_villa_apartment_land_en' => 'Enter villa apartment land in English',
        'enter_age_of_the_property' => 'Enter age of the property in Arabic',
        'enter_services_related_to_the_property_ar' => 'Enter services related to the property in Arabic',
        'enter_services_related_to_the_property_en' => 'Enter services related to the property in English',
    ],
    ...
    'balance'                 => 'balance',
    'categories' => 'Categories ::',
    'sub_categories' => 'SubCategories For this Category ::',
