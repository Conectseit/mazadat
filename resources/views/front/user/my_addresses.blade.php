...
{{--            <h3>{{ trans('messages.user.addresses')}}</h3>--}}
...
{{--                <b>{{isset(auth()->user()->city)? auth()->user()->city->$name : ''}}/--}}
{{--                    {{ isset(auth()->user()->block)?auth()->user()->block: old('block')}}/--}}
{{--                    {{ auth()->user()->street}}/{{ auth()->user()->block_num}}/{{ auth()->user()->signs}}--}}
{{--                </b>--}}
{{--                <div>--}}
{{--                    <a--}}
{{--                       style="background-color:wheat;">--}}
{{--                        <i class="fa fa-bin"></i>@lang('messages.delete')--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--                <h6>--}}
{{--                    on google map--}}
