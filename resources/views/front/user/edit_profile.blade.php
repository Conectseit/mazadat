                    ...
                    <div class="inputs-group">
                        ...
                        <div class="form-group mb-4 row">
                            <div class="col-lg-2 col-md-3 d-flex align-items-center">
                                <label for="name" class="form-label">{{trans('messages.enter_first_name')}}</label>
                            </div>
                        ...
                        <div class="form-group mb-4 row">
                            <div class="col-lg-2 col-md-3 d-flex align-items-center">
                                <label for="name" class="form-label">{{trans('messages.enter_middle_name')}}</label>
                            </div>
                            <div class="col-lg-10 col-md-9">
                        ...
                        <div class="form-group mb-4 row">
                            <div class="col-lg-2 col-md-3 d-flex align-items-center">
                                <label for="name" class="form-label">{{trans('messages.enter_last_name')}}</label>
                            </div>
                            <div class="col-lg-10 col-md-9">
                                ...
                                <div class="row">
                                    <div class="col-xl-3 col-lg-4 col-sm-6"3>
                                        <select class="form-select form-control" name="phone_code"
                                            ...
                                            <option selected disabled>{{ isset(auth()->user()->country)? auth()->user()->country->$name :  trans('messages.choose_country_code') }}</option>
...
{{--                                        <option selected disabled>{{trans('messages.select')}}</option>--}}
                                        <option selected disabled>{{ isset(auth()->user()->nationality)? auth()->user()->nationality->$name :  trans('messages.select') }}</option>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group">
                                <img src=" {{auth()->user()->passport_image_path}} " width=" 100px " value="{{auth()->user()->passport_image_path}}"
