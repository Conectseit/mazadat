...
{{--                    {{App\Models\Setting::where('key',$about)->first()->value}}--}}
                ...
                <div class="links" >
                    <a href="{{route('front.condition_and_terms')}}">{{trans('messages.terms')}} <i class="fal fa-chevron-{{ arrow('left','right') }}" ></i></a>
                    <a href="{{route('front.description')}}">{{ trans('messages.settings.description') }}<i class="fal fa-chevron-{{ arrow('left','right') }}"></i></a>
                    <a href="{{route('front.privacy')}}">{{ trans('messages.settings.privacy') }}<i class="fal fa-chevron-{{ arrow('left','right') }}"></i></a>
                </div>
            </div>
