                    ...
                    <div class="col-sm-6">
                        ...
                        @if(auth()->check())
                            ...
                            @if(auth()->user()->is_verified==1)
                                <a class="btn"
                                   href="{{route('front.show_add_auction_person')}}"
                                   style=" box-shadow: 5px 10px #888888;  text-align: center;border: 1px solid #fff; padding: 8px; color: #fff; font-size: 20px; background: #d1915c;">
                                    <i
                                    ...
                                    @if(auth()->user()->is_company == $auction->who_can_see || $auction->who_can_see == 'all' )
                                        ...
                                        <div class="col-lg-4 col-md-6" id="viewItem">
                                            <div class="card gallery-card" id="itemCard" style="height: 367px !important;">
                                                <a href="{{route('front.auction_details_person',$auction->id)}}" class="image">
