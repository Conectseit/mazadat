...
{{--    @include('front.auctions.parts.head')--}}
    <section class="sign-up-page">
        ...
        <div class="container">
            ...
            <div class="row">
                <form action="{{route('front.auction_update_person',$auction)}}" method="post" id="submitted-form"
                    ...
                    <div class="inputs-group">
                        ...
                        <div class="inputs-group" id="real_estate">
                            ...
                            @include('front.in_person_auctions.parts.update_real_estate')
