...
@section('content')
    ...
    <div class="category-items-page">
        ...
        <section class="items" dir="{{ direction() }}">
            <div class="container">
                <div class="title">
                    <h5>@lang('messages.product.sale')</h5>
                </div>
                <br>
...
{{--                                        <a href="{{route('front.product_details',$product->id)}}" class="image">--}}
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <p><i class="fal fa-location-arrow"></i>
                                                        {{trans('messages.auction.street')}}
                                                        : {{ ($product->$street ) }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-6">
                                                    <p><i class="fal fa-magnet"></i>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <p><i class="fal fa-balance-scale"></i>
