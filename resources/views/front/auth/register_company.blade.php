...
{{--                                "https://assets.wasalt.com/others/icons/villas-for-sale-in-makkah.jpeg"--}}
                            ...
                            @error('company_authorization_image')<span style="color: #e81414;">{{ $message }}</span>@enderror
...
{{--                        <div id="location" style="display:block;">--}}
                            <div class="form-group row ">
                                ...
                                <div class="col-lg-2 col-sm-12 d-flex align-items-center">
                                    <img  id="img-preview2" style="width: 180px ; height:90px" src="{{ asset('uploads/images.jpg') }}" width="250px" />
                                </div>
                                @error('commercial_register_image')<span style="color: #e81414;">{{ $message }}</span>@enderror
