...
@section('title', trans('messages.create-var',['var'=>trans('messages.page.page')]))
@section('style')
    <style>
...
@section('breadcrumb')
    <div class="breadcrumb-line">
        <ul class="breadcrumb">
            ...
            <li class="active">@lang('messages.create-var',['var'=>trans('messages.page.page')])</li>
        </ul>
...
@section('content')
    ...
    <div class="row" style="padding: 15px;">
        <div class="col-md-9">
            ...
            <!-- Basic layout-->
            <form action="{{ route('pages.store') }}" class="form-horizontal" method="post" id="submitted-form"
                  enctype="multipart/form-data">
                @csrf
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">@lang('messages.create-var',['var'=>trans('messages.page.page')])</h5>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="{{ old('meta_title') }}" name="meta_title"
                                       placeholder="@lang('messages.page.meta_title')" required>
                                <span class="label-text"></span>
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="{{ old('meta_description') }}" name="meta_description"
                                       placeholder="@lang('messages.page.meta_description')" required>
                                <span class="label-text"></span>
