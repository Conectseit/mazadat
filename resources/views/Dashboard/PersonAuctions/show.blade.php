                                                    ...
                                                    @if(isset($auction->extra))
                                                        <div class="form-group row">
                                                            <label
                                                                ...
                                                                :</label>
                                                            <div class="col-lg-8">
                                                                <a href="{{route('person_auction_view',$auction->id)}}"
                                                                   target="_blank"> <i class="icon-file-pdf"
                                                                                       style="color: red;"> </i></a>
                                                                <a href="{{route('person/download',$auction->extra)}}"><i
                                        ...
                                        <table class="table datatable" id="inspection_report_images"
                                            ...
                                            @foreach($inspection_report_images as $inspection_report_image)
                                                <tr id="inspection_report_image-row-{{ $inspection_report_image->id }}">
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{route('person_auction_inspection_view_file',$inspection_report_image->id)}}"
                                                           target="_blank">
                                                            <i class="icon-file-pdf" style="color: red;"> </i>
                                                        </a>
                                                        <a href="{{route('person/download',$inspection_report_image->inspection_report_image)}}"><i
                                                                class="icon-download4"> </i> {{trans('messages.download')}}
                                                        </a>
                                                    </td>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="table-responsive content-group">
                                <!-- Basic layout-->
                                <form action="{{ route('person_addReportFile') }}" class="form-horizontal" method="post"
