<script>
            ...
            if (input.files) {
                ...
                for (i = 0; i < filesAmount; i++) {
                    ...
                    reader.onload = function(event) {
                        $($.parseHTML('<img class="" id="remoove" style="width: 100px;margin: 4px;padding: 8px;">'+
    ...
    // $(function() {
    //     // Multiple images preview in browser for inspection-images
...
{{--$(function() {--}}
{{--// Multiple images preview in browser teeeeeeeeeeeeest--}}
{{--var imagesPreview = function(input, placeToInsertImagePreview) {--}}
{{--if (input.files) {--}}
{{--var filesAmount = input.files.length;--}}
