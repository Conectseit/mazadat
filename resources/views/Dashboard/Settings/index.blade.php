                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('settings.update') }}" method="POST">
                                ...
                                {{ method_field('PUT') }}
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('messages.settings.about_ar') }}
                                        :</label>
                                    <div class="col-lg-9">
                            <textarea rows="5" cols="5" name="about_ar" class="form-control"
                                      placeholder="{{ trans('messages.settings.about_ar') }}">
                                {{ settings('about_ar') }}
                            </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-3">{{ trans('messages.settings.about_en') }}
                                        :</label>
                                    <div class="col-lg-9">
                            <textarea rows="5" cols="5" name="about_en" class="form-control"
                                      placeholder="{{ trans('messages.settings.about_en') }}">
                                {{ settings('about_en') }}
                            </textarea>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <textarea rows="5" cols="5" name="conditions_terms_ar" class="form-control"
                                      placeholder="{{ trans('messages.settings.conditions_terms_ar') }}">
                                {{ settings('conditions_terms_ar') }}
                            </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                            ...
                            <textarea rows="5" cols="5" name="conditions_terms_en" class="form-control"
                                      placeholder="{{ trans('messages.settings.conditions_terms_en') }}">
                                {{ settings('conditions_terms_en') }}
                            </textarea>
                                    </div>
                                </div>
                                <legend class="font-weight-semibold text-uppercase font-size-sm"></legend>
