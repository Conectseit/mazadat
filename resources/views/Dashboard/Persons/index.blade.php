                    ...
                    <div class="panel-body">
                        <div class="tabbable">
                            <ul class="nav nav-pills nav-pills-bordered nav-justified">
                                <li class="active"><a href="#accepted_companies" data-toggle="tab">{{ trans('messages.person.verified') }}</a></li>
                                <li><a href="#not_accepted_companies" data-toggle="tab">{{ trans('messages.person.not_verified') }}</a></li>
                            </ul>
