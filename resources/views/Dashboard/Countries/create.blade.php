    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="active">@lang('messages.create-var',['var'=>trans('messages.country.country')])</li>
            </ul>
    ...
    <div class="row" style="padding: 15px;">
            ...
            <form action="{{ route('countries.store') }}" class="form-horizontal" method="post"
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">{{ trans('messages.country.add') }}</h5>
                    ...
                    <div class="panel-body">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" value="" name="phone_code" placeholder="@lang('messages.country.phone_code') ">
                            </div>
                        </div>
        ...
        <div class="col-md-6">
            <div class="panel panel-flat">
                ...
                <div class="panel-heading">
                    <h5 class="panel-title"> {{ trans('messages.country.latest_countries') }} </h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                            <li><a data-action="collapse"></a></li>
                            <li><a data-action="reload"></a></li>
                ...
                <div class="panel-body">
                    <table class="table table-bordered table-hover">
                        ...
                        @forelse($latest_countries as $country)
                            <tr>
